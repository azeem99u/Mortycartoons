...
import com.azeem.morty.databinding.FragmentEpisodeDetailBinding
...
class EpisodeDetailBottomSheetFragment:BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.episodeLiveData.observe(viewLifecycleOwner){ episode ->
            ...
            binding.epoxyRecyclerView.setControllerAndBuildModels(EpisodeDetailEpoxyModel(episode.characters))
